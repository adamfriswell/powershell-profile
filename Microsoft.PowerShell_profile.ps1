...
. "$repoPath\powershell-profile\scripts\azure\cosmos.ps1"
. "$repoPath\powershell-profile\scripts\azure\func.ps1"
. "$repoPath\powershell-profile\scripts\azure\swa.ps1"
